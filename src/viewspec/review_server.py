...
class ReviewServer:
    ...
    def _chrome_response(self) -> _Response:
        ...
        style = (
            ...
            ".controls{width:100%;display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.controls label{grid-column:1;grid-row:1;align-self:center}"
            ".controls select{grid-column:2/4;grid-row:1;min-width:0;width:100%}.controls #panel-toggle{grid-column:1;grid-row:2}"
            ".controls #share-toggle{grid-column:2;grid-row:2}.controls #mode{grid-column:3;grid-row:2}.controls button{min-width:0;width:100%;padding-inline:8px}"
