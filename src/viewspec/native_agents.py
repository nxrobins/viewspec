...
def agent_instruction_block(target: str) -> str:
    ...
    return (
        ...
        "for the human summary and `.viewspec-proof/proof_report.json` for tool output. This proves source artifact "
        "integrity and provenance; it is not pixel-perfect visual regression, accessibility certification, or "
