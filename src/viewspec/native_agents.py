...
def agent_instruction_block(target: str) -> str:
    ...
    return (
        ...
        "Acceptance validates, compiles, checks, retains proof, and exclusively publishes canonical source. It binds "
        ...
        "- For a user-requested product in a blank workspace, use `studio-create` → task-bound candidate → `studio-accept` → `studio`; do not substitute `init-intent` or `init-app` as the finished product.\n"
