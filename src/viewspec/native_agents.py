...
def agent_instruction_block(target: str) -> str:
    ...
    return (
        ...
        "`.viewspec/intent-patch.schema.json`, and `.viewspec/intent-patch-example.dashboard.json`. "
        ...
        "before reusing cached assets. Use the examples only for valid IntentBundle/AppBundle/IntentPatch wire shape; replace all "
