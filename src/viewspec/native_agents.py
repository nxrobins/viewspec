...
def agent_instruction_block(target: str) -> str:
    ...
    return (
        ...
        "artifact, not a deployable React/Vite/Next app, browser-history proof, runtime data binding layer, state store, "
        "mutation handler, or hosted extended behavior claim.\n\n"
        ...
        "`.viewspec/agent-app-bundle.schema.json`, and `.viewspec/agent-app-example.internal-tool.json`. "
        ...
        "before reusing cached assets. Use the examples only for valid IntentBundle/AppBundle wire shape; replace all "
