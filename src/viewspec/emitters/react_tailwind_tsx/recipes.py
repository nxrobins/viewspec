...
TAILWIND_AESTHETIC_RECIPE_OVERLAYS: dict[str, dict[str, str]] = {
    ...
    "aesthetic.brutalist": {
        "app_role:app_shell": "bg-stone-100 px-6 py-6 font-mono text-neutral-950 sm:px-8",
        "app_role:metric_card": "rounded-none border-2 border-neutral-950 bg-white p-4",
        "app_role:form_panel": "rounded-none border-2 border-neutral-950 bg-white p-4",
        "app_role:detail_panel": "rounded-none border-2 border-neutral-950 bg-stone-50 p-4",
        "app_role:data_table": "rounded-none border-2 border-neutral-950 bg-white",
        "app_role:collection_action_bar": "rounded-none border-2 border-neutral-950 bg-white p-3",
        "primitive:button": "rounded-none bg-red-600 px-4 py-2 hover:bg-red-700 focus:ring-red-600",
        "primitive:badge": "rounded-none bg-red-100 text-red-800 ring-red-300",
        "primitive:label": "text-xs font-extrabold uppercase text-neutral-700",
        "primitive:value": "text-2xl font-black leading-tight text-neutral-950",
        "primitive:text": "text-sm leading-6 text-neutral-800",
    },
    "aesthetic.neon_cyber": {
        "app_role:app_shell": "bg-slate-950 px-5 py-5 font-mono text-cyan-50 sm:px-6",
        "app_role:metric_card": "rounded-md border border-cyan-400 bg-slate-900 p-3 shadow-lg",
        "app_role:form_panel": "rounded-md border border-cyan-400 bg-slate-900 p-3 shadow-lg",
        "app_role:detail_panel": "rounded-md border border-cyan-400 bg-slate-900 p-3 shadow-lg",
        "app_role:data_table": "rounded-md border border-cyan-400 bg-slate-900",
        "app_role:collection_action_bar": "rounded-md border border-cyan-400 bg-slate-900 p-2",
        "primitive:button": "rounded-md bg-fuchsia-500 px-4 py-2 text-slate-950 hover:bg-fuchsia-400 focus:ring-fuchsia-500",
        "primitive:badge": "rounded-md bg-fuchsia-500/20 text-fuchsia-200 ring-fuchsia-400",
        "primitive:label": "text-xs font-bold uppercase text-cyan-300",
        "primitive:value": "text-2xl font-bold leading-tight text-cyan-50",
        "primitive:text": "text-sm leading-6 text-cyan-200",
    },
    "aesthetic.warm_organic": {
        "app_role:app_shell": "bg-amber-50 px-8 py-8 text-stone-900 sm:px-10",
        "app_role:metric_card": "rounded-3xl border border-amber-200 bg-white p-6",
        "app_role:form_panel": "rounded-3xl border border-amber-200 bg-white p-6",
        "app_role:detail_panel": "rounded-3xl border border-amber-300 bg-amber-50 p-6",
        "app_role:data_table": "rounded-2xl border border-amber-200 bg-white",
        "app_role:collection_action_bar": "rounded-3xl border border-amber-200 bg-white p-5",
        "primitive:button": "rounded-full bg-amber-700 px-4 py-2 hover:bg-amber-800 focus:ring-amber-700",
        "primitive:badge": "rounded-full bg-amber-100 text-amber-900 ring-amber-200",
        "primitive:label": "text-xs font-semibold uppercase text-stone-500",
        "primitive:value": "text-2xl font-semibold leading-tight text-stone-900",
        "primitive:text": "text-sm leading-7 text-stone-700",
    },
}
