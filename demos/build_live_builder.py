...
{option_html}
    ...
    <section class="mb-4 grid gap-3 text-sm text-slate-400 lg:grid-cols-[1fr_auto] lg:items-center">
      <div>
        <div class="pretext-canvas-wrap max-w-2xl">
          <canvas id="preset-title" data-pretext-canvas data-text="Invoice" data-size="24" data-weight="900" data-line-height="30" class="text-white" role="img" aria-label="Invoice">Invoice</canvas>
        </div>
        <div class="pretext-canvas-wrap mt-1 max-w-2xl">
          <canvas id="preset-description" data-pretext-canvas data-text="A table motif for five invoice line items." data-size="14" data-weight="400" data-line-height="22" class="text-slate-400" role="img" aria-label="A table motif for five invoice line items.">A table motif for five invoice line items.</canvas>
        </div>
      </div>
    ...
    <section class="grid flex-1 gap-4 lg:grid-cols-3">
        ...
        <header class="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-3">
          <div>
            <div class="pretext-canvas-wrap w-40">
              <canvas data-pretext-canvas data-text="Intent JSON" data-size="16" data-weight="800" data-line-height="20" class="text-white" role="img" aria-label="Intent JSON">Intent JSON</canvas>
            </div>
            <div class="pretext-canvas-wrap mt-1 w-44">
              <canvas data-pretext-canvas data-text="IntentBundle input" data-size="12" data-weight="500" data-line-height="16" class="text-slate-400" role="img" aria-label="IntentBundle input">IntentBundle input</canvas>
            </div>
          </div>
      ...
      <article class="panel">
        <header class="border-b border-white/10 px-4 py-3">
          <div class="pretext-canvas-wrap w-40">
            <canvas data-pretext-canvas data-text="CompositionIR" data-size="16" data-weight="800" data-line-height="20" class="text-white" role="img" aria-label="CompositionIR">CompositionIR</canvas>
          </div>
          <div class="pretext-canvas-wrap mt-1 w-44">
            <canvas data-pretext-canvas data-text="Native details tree" data-size="12" data-weight="500" data-line-height="16" class="text-slate-400" role="img" aria-label="Native details tree">Native details tree</canvas>
          </div>
        </header>
      ...
      <article class="panel">
        <header class="border-b border-white/10 px-4 py-3">
          <div class="pretext-canvas-wrap w-44">
            <canvas data-pretext-canvas data-text="Rendered Output" data-size="16" data-weight="800" data-line-height="20" class="text-white" role="img" aria-label="Rendered Output">Rendered Output</canvas>
          </div>
          <div class="pretext-canvas-wrap mt-1 w-52">
            <canvas data-pretext-canvas data-text="HTML emitted from compiled IR" data-size="12" data-weight="500" data-line-height="16" class="text-slate-400" role="img" aria-label="HTML emitted from compiled IR">HTML emitted from compiled IR</canvas>
          </div>
        </header>
  ...
  <script>
    ...
    function activatePreset(key) {{
      ...
      if (!preset) return;
      setCanvasText(presetTitle, preset.label);
      setCanvasText(presetDescription, preset.description);
