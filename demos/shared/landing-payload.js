...
const MOOD_PROFILES = Object.freeze({
  ...
  urgent: {
    accent: '#dc2626',
    accentBg: 'rgba(248, 113, 113, 0.13)',
    warning: '#dc2626',
    warningBg: 'rgba(254, 226, 226, 0.82)',
    surface: '#fffaf5',
    badgeBg: '#fee2e2',
    badgeText: '#991b1b',
    shadow: '0 14px 32px rgba(127, 29, 29, 0.14)',
...
function baseStyleValues(hints = {}) {
  ...
  return {
    ...
    'surface.card': [
      `background: linear-gradient(135deg, var(--kpi-accent-bg, ${profile.surface.background}), #ffffff 64%)`,
